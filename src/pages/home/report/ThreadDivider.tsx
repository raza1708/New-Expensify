...
function ThreadDivider({ancestor, isLinkDisabled = false}: ThreadDividerProps) {
    ...
    return (
        <View
            style={[styles.flexRow, styles.alignItemsCenter, styles.ml5, styles.mt3, styles.mb1, styles.userSelectNone as ViewStyle]}
            accessibilityLabel='data-selection-scraper-hidden-element'
