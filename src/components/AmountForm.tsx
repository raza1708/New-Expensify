...
function AmountForm(
    ...
    return (
        <>
            <View
                id={AMOUNT_VIEW_ID}
                onMouseDown={(event) => focusTextInput(event as unknown as React.MouseEvent<Element, MouseEvent>, [AMOUNT_VIEW_ID])}
            ...
            {canUseTouchScreen ? (
                <View
                    onMouseDown={(event) => focusTextInput(event as unknown as React.MouseEvent<Element, MouseEvent>, [NUM_PAD_CONTAINER_VIEW_ID, NUM_PAD_VIEW_ID])}
